...
##    print(cardstr)
    if cardstr in str(CardInfo):  # CardIfo 为Int64, 而cardstr 为字符串。
        temp1 = list(df.iloc[i,[0,1,2,5,9]])
        temp1[1] = cardstr
        NewXF.append(temp1)        
...
##        print(NewInfo)
        try:
            ...
            print("没有 sheet，需要创建,当前酒店：" + hotelname)
...
##        print(Input)
        Input = Input.sort_values(by = "操作时间")
...
##    print(PreInfo)    
    ...
    PreInfo = PreInfo.sort_values(by = "操作时间")
##    print("----------------去重复后--------------------------")
##    print(PreInfo)    
